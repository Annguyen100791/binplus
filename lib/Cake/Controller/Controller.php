 ...
 * is the filename in /app/View/<SubFolder> without the .php extension.
 *
 * @var string
 */
	public $view = null;
 ...
 * is the filename of the layout in /app/View/Layouts without the .php
 * extension.
 *
 * @var string
 */
...
/**
 * File extension for view templates. Defaults to Cake's conventional ".php".
 *
 * @var string
 */
	public $ext = '.php';
 ...
 * Uses flash.php as the default layout for the message.

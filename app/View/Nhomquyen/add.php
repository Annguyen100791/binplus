<!--  start page-heading -->
<div id="page-heading">
	<div style="float:left"><h1>Nhập mới Nhóm Quyền hạn</h1></div>
...
<?php
	echo $this->Form->create('Nhomquyen', array('id'	=>	'form-nhomquyen-add'));
?>
    <p>
    <?php
        ...
        <table id="quyen-data">
			...
			for($i = 0; $i < count($quyen); $i++):
				...
				?>
                	<tr>
                    	<td></td>                        
						<td style="padding-left:20px"><input name="data[QuyenNhomquyen][quyen_id][<?php echo $quyen[$i]['Quyen']['id'] ?>]" type="checkbox" value="<?php echo $quyen[$i]['Quyen']['id'] ?>" /> &nbsp;&nbsp;<?php echo $quyen[$i]['Quyen']['ten_quyen'] ?></td>
                        <td>
						<?php 

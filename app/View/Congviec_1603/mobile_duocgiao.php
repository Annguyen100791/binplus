...
<div data-role="page" id="congviec-duocgiao" data-loai="<?php echo $loai ?>">
    ...
    <div data-role="content">
    	...
    	<ul data-role="listview" id="congviec-duocgiao-list" data-inset="true">
    ...
    <div data-role="footer">
		<div data-role="controlgroup" data-type="horizontal" id="pagination">
        	<button type="button" id="congviec-duocgiao-prev" disabled="disabled" data-icon="arrow-l">Trang trước</button>
        	<button type="button" id="congviec-duocgiao-next" disabled="disabled" data-icon="arrow-r">Trang sau</button>
        </div>
	</div>
</div>
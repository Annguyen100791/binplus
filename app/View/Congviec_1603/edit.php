        ...
        <div class="content-box-content">
            ...
            <div class="tab-content" id="congviec-nhan">
                <div style="padding:10px">
                    ...
                    <a class="button" href="<?php echo '/congviec/add_nguoinhanviec/' . $this->data['Congviec']['id']?>" data-mode="ajax" data-action="dialog" title="Chọn nhân sự thực hiện công việc" data-width="800">Thêm mới Người nhận việc</a>

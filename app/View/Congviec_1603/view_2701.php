        ...
        <div style="padding-bottom:20px">
            ...
            <div style="float:right; margin-left:20px; ">
                ...
                <div style="float:left; margin-left:10px;margin-top:3px">
                	<a href="/congviec/update_progress/<?php echo $this->data['Congviec']['id'] ?>" data-mode="ajax" class="button" data-action="dialog" data-width="400" title="Cập nhật mức độ hoàn thành công việc">Cập nhật</a>
                </div>
                <?php endif;?>
                <div style="clear:both"></div>
            </div>

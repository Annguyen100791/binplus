...
<div style="padding:20px">
    <div class="content-box" id="congviec-box"><!-- Start Content Box -->
        ...
        <div class="content-box-header">
            ...
            <h3><?php echo $this->Html->image('icons/note.png', array('align' => 'left')) ?>&nbsp; Công việc được giao</h3>
            
            <ul class="content-box-tabs">
                <li><a href="#congviec-all" class="default-tab" rel="congviec-all" id="congviec-all-tab"><?php echo $this->Html->image('icons/note.png', array('align' => 'left')) ?>&nbsp; Tất cả</a></li>
                <li><a href="#congviec-instant" rel="congviec-instant" id="congviec-instant-tab"><?php echo $this->Html->image('icons/note_error.png', array('align' => 'left')) ?>&nbsp; Công việc khẩn</a></li>
                <li><a href="#congviec-baocao" rel="congviec-baocao" id="congviec-baocao-tab"><?php echo $this->Html->image('icons/note_error.png', array('align' => 'left')) ?>&nbsp; Cần theo dõi và báo cáo</a></li>
                <li><a href="#congviec-progressing" rel="congviec-progressing" id="congviec-progressing-tab"><?php echo $this->Html->image('icons/note_go.png', array('align' => 'left')) ?>&nbsp; Đang thực hiện</a></li>

<!--  start page-heading -->
<div id="page-heading">
	<div style="float:left"><h1>Thống kê chi tiết việc truy cập website của Nhân viên</h1></div>
...
<tr>
    ...
    <div id="content-table-inner">
		<div>
    	<form id="form-report-nhanvien" method="post" action="/report/signin_nhanvien">
        	<table width="100%">
                <tr style="height:37px">
                	<td style="text-align:center;  padding-right:10px">
                        ...
                        &nbsp;
                        <input class="button" type="button" value="Thống kê" id="btn-report-nhanvien" />
                        <button class="button" type="button" id="btn-export-excel-nv">Xuất Excel</button>
                    </td>
                </tr>
            </table>
        </form>	
    ...
    <div id="report-content-nhanvien">
	</div>

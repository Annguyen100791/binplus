<?php
	echo $this->Form->create('Tinhchatcongtac', array('id' => 'form-tinhchatcongtac-edit', 'url' => '/tinhchatcongtac/edit'));
...
<script>
	$(document).ready(function(){
		$('#form-tinhchatcongtac-edit').validate({
			errorElement: 	"em",
			errorClass:		"warning",
			rules:{
			...
			submitHandler: function(form){
				$.ajax({
					...
					async:		false,
					dataType:	'json',
					data:	$('#form-tinhchatcongtac-edit').serialize(),

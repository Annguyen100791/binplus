...
<div class="content-box-header"> <!-- Add the class "closed" to the Content box header to have it closed by default -->
    ...
    <div style="float:right;">
        ...
        <ul class="shortcut-buttons-set" style="padding:6px 0px!important">
			...
			<li><a class="shortcut-button" href="javascript:void(0)" title="CLick để đóng chọn nhiều người" id="gui-nhieunguoi-close"><img src="/img/icons/cross.png"/></a></li>
	...
	$(document).ready(function(){
		...
		$("#nhanvien-ds").dynatree({
			...
			onPostInit:	function(isReloading, isError){
				...
				if( $('#nv_selected').length > 0 && $('#nv_selected').val() != '')
			...
			onClick: function(node, event) {
				...
				if(!node.bSelected && node.data.isroot)

				{

					if(confirm("Bạn muốn chọn gửi tin toàn Viễn thông?"))
...
//			idPrefix: "dynatree-Cb3-",
		...
		/*$('#gui-nhieunguoi-close').click(function(){

			$('#tinnhan_nhantinnhan').hide();

<div id="nhanvien-list" style="height:300px; overflow: auto; border:1px solid #CCC">
    <ul>
			...
			?>
            	<li class="<?php echo $class ?>" style="padding-left:<?php echo $ds[$i]['Phong']['padding'] ?>px">
					...
					?>
						...
						?>
                        	<li>
                            	<input type="checkbox" name="data[Nhanvien][][id]" value="<?php echo $nhanvien['Nhanvien']['id'] ?>" />
                                <span>

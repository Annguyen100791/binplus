    ...
    <div class="content-box-content">
    	...
    	<div class="tab-content" id="file-vanban-<?php echo $i ?>">
        	<div align="right" style="padding:5px">
                <!--<a target="_blank" href="<?php //echo Configure::read('VanBan.attach_path') . $item['ten_moi'] ?>" class="button"><?php//echo $this->Html->image('icons/disk.png', array('align' => 'left')) ?>&nbsp; Download file</a>&nbsp; -->
				...
				<?php endif;?>
				<?php if($this->Layout->check_permission('VanBan.duyet') && $this->data['Vanban']['tinhtrang_duyet'] == 2) : 
                ?>
				...
				<?php endif;?> 
                <?php if($this->data['Vanban']['chieu_di'] == 1 && $this->data['Vanban']['tinhtrang_duyet'] == 1) : ?>
			...
			$(document).ready(function(){
				var file = "/vanban/get_files/<?php echo $id ?>";

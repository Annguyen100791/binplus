...
<?php
	...
	?>
    	<tr>
            ...
            <td>
            <?php
				echo $this->Html->link($item['Tintuc']['tieu_de'], '/tintuc/view/' . $item['Tintuc']['id'], array('title' => 'Xem chi tiết thông tin mới', 'escape' => false, 'data-mode' => 'ajax', 'data-action' => 'dialog'));
			?>
            </td>
            ...
            <?php
				...
				{
					echo $this->Html->link($this->Html->image('icons/pencil.png'), '/tintuc/edit/' . $item['Tintuc']['id'], array('title' => 'Hiệu chỉnh thông tin mới', 'escape' => false, 'data-mode' => 'ajax', 'data-action' => 'dialog'));

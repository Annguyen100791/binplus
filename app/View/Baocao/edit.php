<!--  start page-heading -->
<div id="page-heading">
	<div style="float:left"><h1>Chỉnh sửa văn bản</h1></div>
...
<?php
	...
	if(!empty($this->data['Luuvanban']))
		foreach($this->data['Luuvanban'] as $item)
			array_push($noi_luu, $item['phong_id']);
	...
	echo $this->Form->hidden('ds_noi_luu', array('value' => json_encode($noi_luu), 'id' => 'ds_noi_luu'));
...
?>	
    <div id="compose-list-content">
    	...
    	<div class="content-box" style="width:58%; float:left">
            ...
            <div class="content-box-header">
                <div style="float:left">
                	<h3><?php echo $this->Html->image('icons/page_white_text.png', array('align' => 'left')) ?>&nbsp; Nội dung văn bản</h3>
                </div>
                <div style="float:right;padding:6px">
                	<a class="button" id="btn-vanban-add" style="font-weight:bold;"><span style="padding:7px">Gửi lại văn bản</span></a>
                </div>
                <div style="clear:both"></div>
                ...
                <div class="tab-content default-tab" id="vanban_leftcontent">
                	...
                	<div>
                  	<div style="float:left; width:33%">
                     	<?php
									echo $this->Form->input('loaivanban_id',
										array(
											  'label'	=>	'Loại văn bản <span class="required">*</span>',
											  'div'		=>	false,
											  'class'	=>	'text-input',
											  'style'	=>	'width:100%',
											  'id'		=>	'loaivanban_id',
                  ...
                  <div style="padding-top:10px">
                     <div style="width:20%; float:left">
                        ...
                        <input name="data[Vanban][ngay_phathanh]" id="ngay_phathanh" value="<?php echo $this->Time->format('d-m-Y', $this->data['Vanban']['ngay_phathanh']) ?>" class="text-input" size="15" />
                     </div>
        ...
        <div class="content-box" style="width:40%; float:right" id="vanban_nhanvanban"></div>
        <div class="clear"></div>

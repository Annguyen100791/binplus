	...
	<?php
		...
		?>
        	<script>
				...
				if(prev == undefined)
				{
					$('#theodoi-prev').button('disable');
				}else
				{
					$('#theodoi-prev').button('enable');
					$('#theodoi-prev').attr('href', prev);
				}
				if(next == undefined)
				{
					$('#theodoi-next').button('disable');
				}else
				{
					$('#theodoi-next').button('enable');
					$('#theodoi-next').attr('href', next);
				}
            </script>
        <?php
	else:

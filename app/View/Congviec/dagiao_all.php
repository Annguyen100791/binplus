...
<div style="padding-top:20px" class="data table-content">
	...
	<table class="treeTable">
        ...
        <tr>
        	...
        	<th width="29">STT</th>
            <th width="225"><?php echo $this->Paginator->sort('ten_congviec', 'Tên công việc', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
            ...
            <th width="80"><?php echo $this->Paginator->sort('NguoiNhanviec.full_name', 'Chịu trách nhiệm chính', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
            <th width="70"><?php echo $this->Paginator->sort('NguoiNhanviec.full_name', 'Người phối hợp', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
            <th width="31"><?php echo $this->Paginator->sort('ngay_batdau', 'Ngày bắt đầu', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
            <th width="30"><?php echo $this->Paginator->sort('ngay_ketthuc', 'Ngày hoàn thành', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
            <th width="82"><?php echo $this->Paginator->sort('loaicongviec_id', 'Loại công việc', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
            <th width="53"><?php echo $this->Paginator->sort('mucdo_hoanthanh', 'Hoàn thành', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>           
            <th width="50">Thao tác</th>
 <!--<th><?php //echo $this->Paginator->sort('mucdo_hoanthanh', 'Files đính kèm', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?><td width="25"></th> -->        </tr>
        </thead>
...
if(!empty($item['Congviec']['so_nguoiphoihop'])){
			...
			//echo $this->Html->link($item['NguoiNhanviec']['full_name'], '/congviec/view/' . $item['Congviec']['id']);
            ...
            <!--<td><?php 
...

					{
						...
						foreach($item['Filecongviec'] as $file):
			...
			//echo $this->Html->link($this->Html->image('icons/disk.png', array('class' => 'icon-button')), '/vanban/download_files/'. $item['Filedinhkem']['ten_cu'], array('title' => 'Download file văn bản đính kèm', 'escape' => false)); ?>
            ...
            <?php
...

				{
					...
					echo '&nbsp;';
   					 ...
   					 echo $this->Html->link($this->Html->image('icons/note_delete.png', array('class' => 'icon-button')), '/congviec/delete/opt:all', array('title' => 'Xóa công việc đã giao này', 'data-mode' => "ajax", 'data-action' => 'delete-item', 'data-confirm' => 'Bạn có muốn xóa Công việc này không ?', 'data-id' => $item['Congviec']['id'], 'data-target' => 'congviec-all', 'escape' => false));
        	...
        	<td colspan="9">
            	...
            	<div class="pagination">
                	...
                	[Trang <?php echo $this->Paginator->counter(); ?> ] &nbsp;
                        ...
                        <?php echo $this->Paginator->last('>|', array('class' => 'number', 'data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'))?>                </div>

...
<div class="table-content data">
	<table id="search-data">
        ...
        <tr>
            ...
            <th width="90px"><?php echo $this->Paginator->sort('Vanban.chieu_di', 'Chiều VB', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'vanban-search-content'));?></th>
            <th width="90px"><?php echo $this->Paginator->sort('Vanban.ngay_phathanh', 'Ngày phát hành', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'vanban-search-content'));?></th>
            <th width="160px"><?php echo $this->Paginator->sort('Vanban.noi_gui', 'Nơi phát hành', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'vanban-search-content'));?></th>
            <th width="160px"><?php echo $this->Paginator->sort('Vanban.nguoi_ky', 'Người ký', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'vanban-search-content'));?></th>
            <th width="40%"><?php echo $this->Paginator->sort('Vanban.trich_yeu', 'Trích yếu', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'vanban-search-content'));?></th>
            <th width="1px"></th>
        </tr>
        </thead>
    <tbody>

...
<div style="padding-top:20px" class="data table-content">
    ...
    <table class="treeTable">
        ...
        <tr>
        	<th width="1px">STT</th>
            <th width="120px"><?php echo $this->Paginator->sort('ten_congviec', 'Tên công việc', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'cvdagiao-list-content'));?></th>
           <!-- <th width="120px"><?php echo $this->Paginator->sort('NguoiGiaoviec.full_name', 'Người giao việc', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'cvdagiao-list-content'));?></th> -->
            ...
            <th><?php echo $this->Paginator->sort('Vanban.trich_yeu', 'Trích yếu VB', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'cvdagiao-list-content'));?></th>
            <th width="150px"><?php echo $this->Paginator->sort('Phongchutri.ten_phong', 'Đơn vị chủ trì', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'cvdagiao-list-content'));?></th>
            <th width="150px"><?php echo $this->Paginator->sort('Vanban.trich_yeu', 'Đơn vị phối hợp', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'cvdagiao-list-content'));?></th>
    ...
    <?php
        ...
        <tr class="<?php echo $class ?>">
            ...
            <td><?php if(isset($item['Vanban']['Phongchutri']) && !empty($item['Vanban']['Phongchutri']))
						echo $item['Vanban']['Phongchutri']['ten_phong'] ?>
            </td>
            <td><?php if(isset($item['Vanban']['Phongphoihop']) && !empty($item['Vanban']['Phongphoihop']))
						foreach($item['Vanban']['Phongphoihop'] as $i):

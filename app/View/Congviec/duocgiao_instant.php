	...
	<table class="treeTable">
        ...
        <thead>
            ...
            <tr>
                ...
                <th width="225"><?php echo $this->Paginator->sort('ten_congviec', 'Tên công việc', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-instant'));?></th>
<th width="202"><?php echo $this->Paginator->sort('Vanban.trich_yeu', 'Trích yếu văn bản', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
              <th width="83"><?php echo $this->Paginator->sort('NguoiGiaoviec.full_name', 'Người giao việc', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-instant'));?></th>

                <th width="87"><?php echo $this->Paginator->sort('NguoiNhanviec.full_name', 'Người phối hợp', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
                <th width="48"><?php echo $this->Paginator->sort('ngay_batdau', 'Ngày bắt đầu', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-instant'));?></th>

                <th width="52"><?php echo $this->Paginator->sort('ngay_ketthuc', 'Ngày hoàn thành', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-instant'));?></th>

                <th width="70"><?php echo $this->Paginator->sort('loaicongviec_id', 'Loại công việc', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-instant'));?></th>

                <th width="40"><?php echo $this->Paginator->sort('mucdo_hoanthanh', 'Hoàn thành', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-instant'));?></th>
    ...
    <tfoot>
    	...
    	<tr>
            ...
            <div style="float:left; padding: 20px 0">
        		...
        		<a href="/congviec/mark_read/type:instant" class='button' data-mode="ajax" data-action="delete-all"  data-msg="Vui lòng chọn trong danh sách" data-confirm="Chức năng này để cập nhật tiến độ 100% những công việc không liên quan, bạn có đồng ý cập nhật không ?" data-target="congviec-instant">Đánh dấu </a>    		</div>            </td>
            ...
            <td colspan="8">
            	...
            	<div class="pagination">
                	...
                	[Trang <?php echo $this->Paginator->counter(); ?> ] &nbsp;
                        ...
                        <?php echo $this->Paginator->last('>|', array('class' => 'number', 'data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-instant'))?>                </div>

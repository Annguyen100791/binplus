...
<div style="padding-top:20px" class="data table-content">
	<table class="treeTable">
        ...
        <thead>
            <tr>
               <th width="29">STT</th>
            <th width="100"><?php echo $this->Paginator->sort('ten_congviec', 'Tên công việc', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
            <th width="209"><?php echo $this->Paginator->sort('Vanban.trich_yeu', 'Trích yếu văn bản', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
            <th width="97"><?php echo $this->Paginator->sort('NguoiNhanviec.full_name', 'Chịu trách nhiệm chính', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
            <th width="78"><?php echo $this->Paginator->sort('NguoiNhanviec.full_name', 'Người phối hợp', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
            <th width="40"><?php echo $this->Paginator->sort('ngay_batdau', 'Ngày bắt đầu', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
            <th width="37"><?php echo $this->Paginator->sort('ngay_ketthuc', 'Ngày hoàn thành', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
            <th width="30"><?php echo $this->Paginator->sort('loaicongviec_id', 'Loại công việc', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>
            <th width="36"><?php echo $this->Paginator->sort('mucdo_hoanthanh', 'Hoàn thành', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'congviec-all'));?></th>           
            <th width="58">Thao tác</th>
            </tr>
             ...
             <?php
...

                {
                    ...
                    echo '&nbsp;';
                     ...
                     echo $this->Html->link($this->Html->image('icons/note_delete.png', array('class' => 'icon-button')), '/congviec/delete/opt:unfinished', array('title' => 'Xóa công việc đã giao này', 'data-mode' => "ajax", 'data-action' => 'delete-item', 'data-confirm' => 'Bạn có muốn xóa Công việc này không ?', 'data-id' => $item['Congviec']['id'], 'data-target' => 'congviec-unfinished', 'escape' => false));

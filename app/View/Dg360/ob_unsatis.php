<!--  start page-heading -->
<div id="page-heading">
	<div style="float:left"><h2>Báo cáo các lý do không hài lòng</h2></div>
...
<tr>
    ...
    <div id="content-table-inner">
		<div>
    	<form id="form-report" method="post" action="/dg360/ob_unsatis">
        	<table width="100%">
...
<script>
	...
	$('#btn-report').click(function(e){
			e.preventDefault();
			$('#form-report').attr('action', BIN.baseURL + 'dg360/ob_unsatis');
			$('#report-content').html('<img src="/img/circle_ball.gif">');
			$.ajax({
				type:		'POST',
				url:		  '/dg360/ob_unsatis',
	...
	$('#btn-export-excel').click(function(e){
			e.preventDefault();
			$('#form-report').attr('action', BIN.baseURL + 'dg360/unsatis_excel');
			$('#form-report').submit();
		});
</script>

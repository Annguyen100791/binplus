...
<div class="right">
    ...
    <ul class="greyarrow">
		...
		<?php
			...
			if(!empty($vanban_thaydoi)&& ($this->Session->read('Auth.User.nhanvien_id') <> 681))
		...
		<?php
			...
			//if(!empty($vb_notice))
                ...
                //echo $this->Html->link($vb_notice . ' văn bản đến có giao ngày hoàn thành trễ tiến độ.', '/vanban/index_notice#notice-gap');
    ...
    <ul class="greyarrow">
        ...
        <?php 
            ...
            if(empty($dagiao_comment_moi))
                ...
                echo $this->Html->link($duocgiao_comment_moi . ' công việc đã giao có thảo luận mới.', '/congviec/dagiao#congviec-commentmoi');

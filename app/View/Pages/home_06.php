...
<tr>
	...
	<!-- BEGIN CONTENT -->
    	<div id="home-content">
            <div style="background:url(/img/icons/sound.png) left top no-repeat; padding-left:30px">
                <h2><a href="/tintuc" title="Xem toàn bộ thông tin trước đó">Thông tin mới</a></h2>
            </div>
            <div>
            	<div style="float:left; vertical-align:top">
                	<img src="/img/shared/tbao.png" />
                </div>
                <div id="news-content" style="padding:0 30px; float:left; width:450px">
            ...
            <div>
                <div style="background:url(/img/icons/calendar_view_day.png) left top no-repeat; padding-left:30px">
                    <h2><a href="/calendars/lamviec/1" title="xem toàn bộ lịch công tác">Lịch làm việc <?php echo $phong['Phong']['ten_phong'] ?> </a></h2>
                </div>
                <div>
                	<div style="float:left; vertical-align:top">
                        <img src="/img/shared/lich.png" />

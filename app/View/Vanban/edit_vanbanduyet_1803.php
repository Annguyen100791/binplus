    	...
    	<div class="content-box" style="width:58%; float:left">
            <div class="content-box-header">
                ...
                <div style="float:right; padding:6px">
                	<a class="button" id="btn-vanban-add" style="font-weight:bold;" title="Click để Duyệt lại văn bản"><span style="padding:7px">Duyệt lại văn bản</span></a>
                </div>
                <div style="clear:both"></div>
                  ...
                  <div style="padding-top:10px" id="vbtime">
					...
					?>
              		  ...
              		  <div style="float:left; padding-left:10px; width:300px" id="vbgap_thoigian">
                            ...
                            <?php else : ?>
                            <b>Ngày hoàn thành:</b><input name="data[Vanban][vbgap_ngayhoanthanh]" id="vbgap_ngayhoanthanh" value="<?php echo $this->Time->format('d-m-Y', $this->data['Vanban']['vbgap_ngayhoanthanh']) ?>" class="text-input" size="15"/>
                            <?php endif;?>
                     </div>
                	</div>
                  <p>

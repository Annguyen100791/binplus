            ...
            <div class="content-box-header">
                ...
                <div style="float:left; padding:6px">
                    ...
                    <div id="chonvanban-container">
                        <a class="button" href="/congviec/chon_vanbannhan" data-mode="ajax" data-action="dialog" title="Chọn văn bản đã nhận" data-width="800">Chọn văn bản</a>
                    </div>
                </div>
            ...
            <div class="content-box-content">
                ...
                <div class="tab-content default-tab" id="vanban_leftcontent">
	               <!-- <div style="padding-top:10px;display:none;" >
                     	<?php
									echo $this->Form->input('id_vanban',
										array(
											  'label'	=>	'ID văn bản <span class="required">*</span>',
											  'div'		=>	false,
											  'class'	=>	'text-input',
											  'style'	=>	'width:100%',
											  'id'		=>	'id_vanban'
                  ...
                  <!--<div id="noidung_loaivb">
                  	<div style="padding-top: 10px">
                     	<div style="float:left; width:100%">
                     	<?php
									echo $this->Form->input('loaivanbanct_id',
										array(
											  'label'	=>	'Chi tiết văn bản <span class="required">*</span>',
											  'div'		=>	false,
											  'class'	=>	'text-input',
											  'style'	=>	'width:100%',
											  'id'		=>	'loaivanbanct_id',
											  'options'	=>	$loaivanban_chitiet,
											  'empty'	=>	false
											  ));
								?>
                       </div>

...
<div style="padding-top:20px" class="data table-content">
	<table>
        ...
        <tr>
            ...
            <th width="80px"><?php echo $this->Paginator->sort('Vanban.ngay_duyet', 'Ngày duyệt', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'gap-list-content'));?></th>
	...
	?>
    	<tr >
            ...
            <?php
				...
				echo $this->Html->link($this->Html->image('icons/note_edit.png', array('class' => 'icon-button')), '/vanban/up_result/'.'id:' . $item['Vanban']['id']. '/'. urlencode("type:index#vanban-gap") , array('title' => 'Cập nhật kết quả xử lý văn bản', 'escape' => false));
			?>
            </td>
        </tr>
    <?php

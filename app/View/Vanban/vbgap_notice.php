...
<div style="padding-top:20px" class="data table-content">
	<table>
        ...
        <tr>
            ...
            <th width="120px"><?php echo $this->Paginator->sort('Vanban.so_hieu', 'Số hiệu VB', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'notice-gap-list-content'));?></th>
            <th width="160px"><?php echo $this->Paginator->sort('Vanban.noi_gui', 'Nơi phát hành', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'notice-gap-list-content'));?></th>
            <th width="80px"><?php echo $this->Paginator->sort('Vanban.ngay_duyet', 'Ngày duyệt', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'notice-gap-list-content'));?></th>
            <th width="100px"><?php echo $this->Paginator->sort('Vanban.vbgap_ngayhoanthanh', 'Ngày hoàn thành', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'notice-gap-list-content'));?></th>
            <th width="320px"><?php echo $this->Paginator->sort('Vanban.trich_yeu', 'Trích yếu', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'notice-gap-list-content'));?></th>
            <th width="120px"><?php echo $this->Paginator->sort('Vanban.phongchutri_id', 'Đơn vị chủ trì', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'notice-gap-list-content'));?></th>
            <th><?php echo $this->Paginator->sort('Vanban.ket_qua', 'Kết quả', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'notice-gap-list-content'));?></th>
            <th width="80px"><?php echo $this->Paginator->sort('Vanban.hoan_thanh', 'Hoàn thành', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'notice-gap-list-content'));?></th>
            <th width="1px"></th>
        </tr>
        </thead>
    <tbody>
	...
	?>
    	<tr >
            ...
            <?php
				...
				echo $this->Html->link($this->Html->image('icons/note_edit.png', array('class' => 'icon-button')), '/vanban/up_result/'.'id:' . $item['Vanban']['id']. '/'. urlencode("type:index_notice#notice-gap") , array('title' => 'Cập nhật kết quả xử lý văn bản', 'escape' => false));
			?>
            </td>
        </tr>
    <?php
    ...
    <!--<div style="float:left; padding: 20px 0">
        <a href="/vanban/mark_read/type:den" class='button' data-mode="ajax" data-action="delete-all"  data-msg="Vui lòng chọn trong danh sách" data-confirm="Bạn có muốn đánh dấu văn bản đã chọn hay không ?" data-target="notice-gap-list-content">Đánh dấu văn bản đã đọc</a>
    ...
    <div class="pagination">
        ...
        <?php echo $this->Paginator->first('|< Đầu', array('class' => 'number', 'data-mode' => 'ajax','data-action' => 'paging', 'data-target' => 'notice-gap-list-content'))?>
        <?php echo $this->Paginator->prev('< Trước', array('class' => 'number', 'data-mode' => 'ajax','data-action' => 'paging', 'data-target' => 'notice-gap-list-content'))?>
        <?php echo $this->Paginator->numbers(array('separator'=>'&nbsp;', 'class' => 'number', 'data-mode' => 'ajax','data-action' => 'paging', 'data-target' => 'notice-gap-list-content')); ?>
        <?php echo $this->Paginator->next('Sau >', array('class' => 'number', 'data-mode' => 'ajax','data-action' => 'paging', 'data-target' => 'notice-gap-list-content'))?>
        <?php echo $this->Paginator->last('Cuối >|', array('class' => 'number', 'data-mode' => 'ajax','data-action' => 'paging', 'data-target' => 'notice-gap-list-content'))?>
    </div>
    <?php endif;?>
</div>
</div>

...
<div style="padding-top:20px" class="data table-content">
	<table>
        ...
        <tr>
            ...
            <th width="160px"><?php echo $this->Paginator->sort('Vanban.so_hieu', 'Số hiệu VB', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'gap-list-content'));?></th>
            ...
            <th width="80px"><?php echo $this->Paginator->sort('Vanban.ngay_nhap', 'Ngày nhập', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'gap-list-content'));?></th>
            <th width="90px"><?php echo $this->Paginator->sort('Vanban.ngay_nhan', 'Ngày VB đến', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'gap-list-content'));?></th>
            <th width="300px"><?php echo $this->Paginator->sort('Vanban.trich_yeu', 'Trích yếu', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'gap-list-content'));?></th>
            <th><?php echo $this->Paginator->sort('Vanban.ketqua', 'Báo cáo kết quả', array('data-mode' => 'ajax', 'data-action' => 'paging', 'data-target' => 'gap-list-content'));?></th>
            <th width="1px"></th>
        </tr>
        </thead>
    <tbody>

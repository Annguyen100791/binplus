    ...
    <div class="content-box" id="vanban-box"><!-- Start Content Box -->
        <div class="content-box-header">
            ...
            <ul class="content-box-tabs">
                ...
                <li><a href="#vanban-capnhatketqua" class="default-tab" rel="vanban-capnhatketqua" id="vanban-capnhatketqua-tab" title="Danh sách các văn bản đến có deadline"><?php echo $this->Html->image('icons/page_white.png', array('align' => 'left')) ?>&nbsp; VB gấp,báo cáo</a></li>
                <?php endif;?>
                <?php if($this->Layout->check_permission('VanBan.ketqua')): ?>
                <li><a href="#vanban-ketquakhac" class="default-tab" rel="vanban-ketquakhac" id="vanban-ketquakhac-tab" title="Danh sách các văn bản đến khác đã cập nhật kết quả"><?php echo $this->Html->image('icons/page_white.png', array('align' => 'left')) ?>&nbsp; VB khác,báo cáo</a></li>
                <?php endif;?>
        ...
        <div class="content-box-content">
            ...
            <!-- Văn bản đến mang tính quan trọng(Chức năng này dành cho GĐ VTĐN) -->    
            ...
            <!-- Văn bản đến không có deadline, đã cập nhật kết quả xử lý -->    
            <div class="tab-content default-tab" id="vanban-ketquakhac" style="display:none">
                    <div align="right" style="padding-bottom:10px">
                    <form id="form-ketquakhac-search">
                        <?php
                            echo '<b>Từ khóa</b> : ';
                            echo $this->Form->input('Vanban.keyword', 
                                                    array(
                            ...
                            echo $this->Form->input('Vanban.ngay_ketthuc', 
                                                    array(
                                                            ...
                                                            'style'	=>	'width:80px',
                                                            'title'	=>	'Click để chọn ngày',
                                                            'id'	=>	'ketquakhac-ngay-ketthuc'));
                                                            
                        ?>
                        <input class="button" type="submit" value="Tìm kiếm nhanh" id="btn-ketquakhac-search" title="Tìm kiếm nhanh văn bản đến đã cập nhật kết quả xử lý " />
                    </form>
                    </div>
                    <div class="content-box-content" id="ketquakhac-list-content" style="padding:5px 0px">
                        <img src="/img/circle_ball.gif" />
                    </div>
                </div>

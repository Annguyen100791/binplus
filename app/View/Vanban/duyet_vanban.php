    	...
    	<div class="content-box" style="width:58%; float:left">
            <div class="content-box-header">
                ...
                <div style="float:right; padding:6px">
                	<a class="button" id="btn-vanban-add" style="font-weight:bold;" title="Click để Duyệt văn bản"><span style="padding:7px">Duyệt</span></a>
                </div>
                <div style="clear:both"></div>
            ...
            <div class="content-box-content">
                <div class="tab-content default-tab" id="vanban_leftcontent">
                  <!--<div class="content-box" style="width:58%; float:left"> -->
                    ...
                    <br/>
                    <div>
                    <?php if($this->data['Vanban']['chuyen_nguoiduyet'] == 0 || $this->data['Vanban']['uy_quyen'] == 1  ){ ?>
                        <b>Nội dung trình : &nbsp;</b>
                        <br>
                        <?php 
                  ...
                  <div style="padding-top:10px">
					<?php
					if($this->Session->read('Auth.User.donvi_id') == '') // VTĐN ko cần kế thừa nội dung trình của VPTH
					{
					...
					else // Đơn vị thì kế thừa
					{
						if(!empty($this->data['Vanban']['noidung_duyet'])) // có nội dung duyệt của GĐ rồi(t/hợp chuyển PGĐ duyệt)
							echo $this->Form->input('noidung_duyet', 
								array(
							...
							echo $this->Form->input('noidung_duyet', 
								...
								array(
									  ...
									  'id'		=>	'noidung_duyet',
									  'value'	=>	$this->data['Vanban']['noidung_trinh']
                  ...
                  <?php if($this->Session->read('Auth.User.chucdanh_id') == 2 || $this->Session->read('Auth.User.chucdanh_id') == 30 ): ?>
                           <!-- Chỉnh sửa -->
                            <div style="float:left; width:30%">
								...
								?>
								<!-- Cấp VTĐN hoặc TTKD -->
								<?php if($this->Session->read('Auth.User.donvi_id') == '' || ($this->Session->read('Auth.User.donvi_id') == 23)): ?>

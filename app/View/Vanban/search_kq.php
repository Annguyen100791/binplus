    ...
    <div id="content-table-inner">
    	...
    	<form id="form-vanban-search" method="post" action="/vanban/search_kq">
        	<table width="100%">
                ...
                <tr style="height:37px">
                    <td style="text-align:right; padding-right:10px;" width="40%">Phân loại văn bản : </td>
                    <td width="60%">
                    <?php
                        echo $this->Form->input('Vanban.vb_gap',
                           array(
                                'label'	=>	false,
                                'div'	=>	false,
                                'class'	=>	'text-input',
                ...
                <tr style="height:37px">
                 	<td style="text-align:right;  padding-right:10px"  width="40%">Mức độ hoàn thành : </td>
                    <td width="60%">

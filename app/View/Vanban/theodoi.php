...
<div style="padding-top:20px" class="data table-content">
    ...
    <div style="float:left; padding: 20px 0">
        <a href="/vanban/untrack/type:unread" class='button' data-mode="ajax" data-action="delete-all"  data-msg="Vui lòng chọn trong danh sách" data-confirm="Bạn có muốn hủy theo dõi văn bản đã chọn hay không ?" data-target="theodoi-list-content">Hủy bỏ theo dõi văn bản</a>
    </div>

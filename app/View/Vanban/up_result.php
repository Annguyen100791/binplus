...
?>
<div id="page-heading">
	<div style="float:left"><h1>Cập nhật kết quả thực hiện văn bản</h1></div>
...
<?php
	...
	echo $this->Form->hidden('ds_nhan', array('id' => 'ds_nhan', 'value' => implode(',', $ds_nhan)));
    ...
    <div id="compose-list-content">
    	...
    	<div class="content-box" style="width:58%; float:left">
            ...
            <div class="content-box-header">
                <div>
                	<h3><?php echo $this->Html->image('icons/page_white_text.png', array('align' => 'left')) ?>&nbsp; Cập nhật kết quả thực hiện văn bản</h3>
                </div>
                <div style="float:right; padding:6px">
                	<a class="button" id="btn-vanban-add" style="font-weight:bold;" title="Click để Cập nhật"><span style="padding:7px">Cập nhật</span></a>
                </div>
                <div style="clear:both"></div>
...
<script>
	$(document).ready(function(){
		$('#noidung_capnhat').focus();
		
		tinymce.init({
			selector: '#noidung_capnhat',
			//height: 400,
			language: 'vi_VN',

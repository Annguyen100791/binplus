			...
			?>
                <tr>
                    ...
                    <td width="33%" style="padding-top:20px;">
					   ...
					   ////////?>
						<?php
                         if($this->data['Vanban']['nguoi_duyet_id'] == $this->Session->read('Auth.User.nhanvien_id') || $this->data['Vanban']['nguoi_trinh_id'] == $this->Session->read('Auth.User.nhanvien_id') ): ?>
                ...
                <tr>
                    <td colspan="3" style="text-align:right!important; padding-top:10px" >
                        <div>
                            <a href="/vanban/giamdoc_chidao/id:<?php echo $this->data['Vanban']['id'] ?>" data-mode="ajax" data-action="dialog" class="button"><?php echo $this->Html->image('icons/page_white_paintbrush.png', array('align' => 'left')) ?>&nbsp;Giám đốc chỉ đạo</a>
                           
                         	<?php 
							 //echo $this->Html->link($this->Html->image('icons/page_white_paintbrush.png', array('class' => 'button')), '/vanban/giamdoc_chidao/id:' . $this->data['Vanban']['id'], array('escape' => false, 'title' => 'Giám đốc chỉ đạo văn bản này', 'data-mode' => 'ajax', 'data-action' => 'dialog')) . "Giám đốc VTĐN chỉ đạo";
							?>

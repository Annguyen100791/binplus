    ...
    <div class="content-box" id="vanban-box"><!-- Start Content Box -->
        <div class="content-box-header">
            ...
            <ul class="content-box-tabs">
                ...
                <li><a href="#vpth-all" rel="vpth-all" id="vpth-all-tab" title="Tất cả văn bản TH-HC gửi VTĐN"><?php echo $this->Html->image('icons/page_white.png', array('align' => 'left')) ?>TH-HC</a></li>
                <li><a href="#tcld-all" rel="tcld-all" id="tcld-all-tab" title="Tất cả văn bản Nhân sự gửi VTĐN"><?php echo $this->Html->image('icons/page_white.png', array('align' => 'left')) ?>NHAN SU</a></li>
                ...
                <li><a href="#tckt-all" rel="tckt-all" id="tckt-all-tab" title="Tất cả văn bản KH-KT gửi VTĐN"><?php echo $this->Html->image('icons/page_white.png', array('align' => 'left')) ?>KH-KT</a></li>

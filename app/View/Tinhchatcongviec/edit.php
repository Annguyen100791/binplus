<?php
	echo $this->Form->create('Tinhchatcongviec', array('id' => 'form-tinhchatcongviec-edit', 'url' => '/tinhchatcongviec/edit'));
...
<script>
	$(document).ready(function(){
		$('#form-tinhchatcongviec-edit').validate({
			errorElement: 	"em",
			errorClass:		"warning",
			rules:{
			...
			submitHandler: function(form){
				$.ajax({
					...
					async:		false,
					dataType:	'json',
					data:	$('#form-tinhchatcongviec-edit').serialize(),

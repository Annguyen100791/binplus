	...
	?>
    	<tr>
            ...
            <?php
				...
				echo '&nbsp;';
				echo $this->Html->link($this->Html->image('icons/email_delete.png'), '/tinnhan/unread_delete', array('title' => 'Xóa tin nhắn này', 'data-mode' => "ajax", 'data-action' => 'delete-item', 'data-confirm' => 'Bạn có muốn xóa Tin nhắn này không? Ghi chú: Các tin nhắn đã có người đọc sẽ không được xóa', 'data-id' => $item['Chitiettinnhan']['id'], 'data-target' => 'unread-list-content', 'escape' => false));
			?>
            </td>
        </tr>
    <?php

...
<div id="page-heading">
	<div style="float:left"><h1>Soạn thảo tin nhắn</h1></div>
...
<?php
	...
	echo $this->Form->create('Tinnhan', array('id'	=>	'form-tinnhan-compose'));
	
/**********Lấy lại value To, CC, Bcc ******************/	
		$to = $tinnhan['Tinnhan']['nguoigui_id'];					
		$cc= array();
		$bcc=array();
		$nguoinhan = array();
...
/******************* End *************************/	
		...
		/*else
			{echo $this->Form->hidden('nv_selected', array('id' => 'nv_selected', 'value' => $tinnhan['Tinnhan']['nguoigui_id']));}*/
	//echo $this->Form->hidden('nguoinhan_to', array('id' => 'nguoinhan_to', 'value' => $tinnhan['Tinnhan']['nguoinhan_to']));
	if(isset($related_id))
    ...
    <div id="compose-list-content">
    	...
    	<div class="content-box" style="float:left" id="content-box">
                ...
                <h3><?php echo $this->Html->image('icons/page_white_text.png', array('align' => 'left')) ?>&nbsp; Nội dung tin nhắn</h3>
				 ...
				 <div style="float:right; padding:5px 15px">
                    ...
                    <!-- <div style="float:left; padding-left: 10px" id="gui_nhieunguoi" title="Click để chọn gửi nhiều người">
                     	<p style="font-weight:bold;"><a href="#">Gửi nhiều người</a></p>
                     </div>-->
            ...
            <div class="content-box-content">
				...
				<p>
                <div id="bcc_button"><a href="#page-heading" title="Click để chọn gửi đến người nhận Bcc">Bcc</a></div><br>
                <div id="bcc">
							<?php
							...
							if(isset($tinnhan))
							{
								if( isset( $tinnhan['Tinnhan']['tieu_de'] ) )
								{
									if( isset( $tinnhan['Tinnhan']['nguoigui_id'] ) )	// reply
										$title = '[TL]' . $tinnhan['Tinnhan']['tieu_de'];
									else
										$title = '[CT]' . $tinnhan['Tinnhan']['tieu_de'];
                    ...
                    <p>
                    	<?php
							$content = (isset($tinnhan) && isset($tinnhan['Tinnhan']['noi_dung'])) ? '[<br><i>Đã gửi lúc '.$this->Time->format("d-m-Y H:i:s", $tinnhan['Tinnhan']['ngay_gui']).'<br>'. $tinnhan['Tinnhan']['noi_dung'] . '<i> ]' : '';

							if(!empty($signature))

								$content = '<BR><p style="padding:20px 0">' . nl2br($signature) . '</p>'.$content;

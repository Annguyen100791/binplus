    ...
    <div class="content-box-content">
    	<div class="tab-content default-tab" id="message-unread">
            ...
            <div  style="padding:10px">
                ...
                <a class="button" href="/tinnhan/unread_delete"  data-mode="ajax" data-action="delete-all" data-msg="Vui lòng chọn trong danh sách" data-confirm="Bạn có muốn xóa các Tin nhắn đã chọn hay không? Ghi chú: Các tin nhắn đã có người đọc sẽ không được xóa" data-target="unread-list-content" title="Click để xóa các Tin nhắn đã chọn trong danh sách">Xóa</a>
    	...
    	<div class="tab-content" id="message-read">
            ...
            <div  style="padding:10px">
                ...
                <a class="button" href="/tinnhan/read_delete"  data-mode="ajax" data-action="delete-all" data-msg="Vui lòng chọn trong danh sách" data-confirm="Bạn có muốn xóa các Tin nhắn đã chọn hay không? Ghi chú: Các tin nhắn đã có người đọc sẽ không được xóa" data-target="read-list-content" title="Click để xóa các Tin nhắn đã chọn trong danh sách">Xóa</a>
    	...
    	<div class="tab-content" id="message-sent">
            ...
            <div  style="padding:10px">
                <a class="button" href="/tinnhan/compose" title="Click để soạn thảo tin nhắn">Soạn thảo</a>
                <a class="button" href="/tinnhan/sent_delete" data-mode="ajax" data-action="delete-all" data-msg="Vui lòng chọn trong danh sách" data-confirm="Bạn có muốn xóa các Tin nhắn đã chọn hay không? Ghi chú: Các tin nhắn đã có người đọc sẽ không được xóa" data-target="sent-list-content" title="Click để xóa các Tin nhắn đã chọn trong danh sách">Xóa</a>

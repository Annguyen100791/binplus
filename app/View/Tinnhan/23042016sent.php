	...
	?>
    	<tr>
            ...
            <?php
				...
				echo '&nbsp;';
				echo $this->Html->link($this->Html->image('icons/email_delete.png'), '/tinnhan/sent_delete', array('title' => 'Xóa tin nhắn này', 'data-mode' => "ajax", 'data-action' => 'delete-item', 'data-confirm' => 'Bạn có muốn xóa Tin nhắn này không ?', 'data-id' => $item['Tinnhan']['id'], 'data-target' => 'sent-list-content', 'escape' => false));
			?>
            </td>
        </tr>
    <?php

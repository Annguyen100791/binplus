    ...
    */ 
    private function preset($name){ 
        ...
        if($name == 'full'){ 
            return array( 
                'theme' => 'advanced', 
                'plugins' => 'safari,table,inlinepopups,emotions,media,fullscreen,paste',
                'theme_advanced_buttons1' => 'fontselect,fontsizeselect,formatselect,bold,italic,underline,strikethrough,sub,sup,cut,copy,paste,pasteword,undo,redo',
                'theme_advanced_buttons2' => 'justifyleft,justifycenter,justifyright,justifyfull,separator,numlist,bullist,outdent,indent,separator,forecolor,backcolor,separator,hr,removeformat,link,unlink,image,emotions,media',

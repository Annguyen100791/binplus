	...
	compose:	function(){
		...
		$('#form-tinnhan-compose').validate({
			...
			submitHandler: function(form){
				//alert($('#nguoinhan_to').val());
				/*if($('#nv_selected').val() == '' && $('#nguoinhan_to').val()==''){
		...
		//$('#tieu_de').focus();
		$('#nguoinhan_to').select2();
		$('#nguoinhan_cc').select2();
		$('#nguoinhan_bcc').select2();
		
		$('#bcc').hide();
		$('#bcc_button').click(function(){
			//alert($('#bcc').is(':visible'));
			if(($('#bcc').is(':visible')) == false){
				$('#bcc').show();			
			}else{
				$('#bcc').hide();
			}
		...
		$('#content-box').css("width",'62%');
		
		/*$('#gui_nhieunguoi').click(function(){
			$('#tinnhan_nhantinnhan').show();
			$('#content-box').css("width",'62%');
			$('#gui_nhieunguoi').hide();
		});
		*/

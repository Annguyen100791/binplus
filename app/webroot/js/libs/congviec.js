...
var Congviec = {
	...
	dagiao_updateTab:	function(){
...

		{
			...
			case '#congviec-finished':
				...
				break;
			case '#congviec-commentmoi':

				BIN.doUpdate('<a href="congviec/dagiao/opt:commentmoi" data-target="congviec-commentmoi"></a>');
	...
	duocgiao_updateTab:	function(){
...

		{
			...
			case '#congviec-commentmoi':
				...
				BIN.doUpdate('<a href="congviec/duocgiao/opt:commentmoi" data-target="congviec-commentmoi"></a>');
	...
	view:	function(){
		...
		$('#btn-submit-comment').click(function(){
...

			{
				...
				console.log($('congviecchinh_id').val());
...

			{
				...
				$.ajax({
					...
					data:		{congviec_id: $('#congviecchinh_id').val(), noi_dung: content},
...

					{
...

						{
							...
							BIN.doUpdate('<a href="congviec/comments/' + $('#congviecchinh_id').val() +'" data-target="congviec-comments"></a>');
	...
	view_updateTab:	function(){
...

		{
			...
			case '#congviec-progressing':
				...
				BIN.doUpdate('<a href="congviec/nhatky/' + $('#congviecchinh_id').val() + '" data-target="congviec-progressing"></a>');

				break;

			case '#congviec-flow':

				BIN.doUpdate('<a href="congviec/luongcongviec/' + $('#congviecchinh_id').val() + '" data-target="congviec-flow"></a>');
	...
	search:	function(){
		...
		$('#btn-expexcel-search').live('click', function(e){
			...
			$('#form-dagiao-search').attr('action', BIN.baseURL + 'congviec/excel_search');

			$('#form-dagiao-search').attr('method','POST');

			$('#form-dagiao-search').submit();

			$('#form-dagiao-search').attr('action', BIN.baseURL + 'congviec/search');

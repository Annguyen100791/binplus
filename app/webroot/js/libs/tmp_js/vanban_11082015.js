...
var Vanban = {
	index:	function(){
		...
		$('#form-den-search').submit(function(){
			if($(this).attr('action') == BIN.baseURL + 'vanban/den')
			{
		...
		$('#btn-expexcel-den').live('click', function(e){
			e.preventDefault();
			$('#form-den-search').attr('action', BIN.baseURL + 'vanban/excel_den');
			$('#form-den-search').submit();
			$('#form-di-search').attr('action', BIN.baseURL + 'vanban/den');
			return false;
			
		});
		$('#btn-expexcel-di').live('click', function(e){
			e.preventDefault();
			$('#form-di-search').attr('action', BIN.baseURL + 'vanban/excel_di');
			$('#form-di-search').submit();
			$('#form-di-search').attr('action', BIN.baseURL + 'vanban/di');
			return false;
		});
		$('#btn-expexcel-noibo').live('click', function(e){
			...
			$('#form-di-search').attr('action', BIN.baseURL + 'vanban/noibo');
			return false;
		});
	},

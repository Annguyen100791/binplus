  ...
  function initialize(node) {
    if(!node.hasClass("initialized")) {
      ...
      if(node.hasClass("parent")) {
        var cell = $(node.children("td")[options.treeColumn]);
        var padding = getPaddingLeft(cell) + options.padding;
        ...
        if(options.expandable) {
          var newLink = '<a href="#" title="' + options.stringExpand + '" style="margin-left: -' + options.margin + 'px; padding-left: ' + options.padding + 'px" class="expander"></a>';

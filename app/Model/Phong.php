...

{
	...
	*/
...

	{
		...
		$this->recursive = -1;
		//var_dump($phong_id);die();
		if(empty($phong_id))
		{

			$results = $this->find('all', array('order' => array('loai_donvi' => 'ASC','stt' => 'ASC','lft' =>  'ASC'), 'fields' => array('id', 'ten_phong', 'thuoc_phong', 'lft', 'rght')));
			//pr($results);die();
		}

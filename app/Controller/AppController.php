 ...
 */
	...
	const	TRUNGTAM = 3;	const	TRUNGTAM_PHONGBAN = 4;
	...
	public $loai_donvi = array(
		...
		self::VIENTHONG_PHONGBAN_TODOI	=> 'Tổ / Đội thuộc PBCN thuộc viễn thông',		self::TRUNGTAM			=>	'Trung tâm thuộc viễn thông',		self::TRUNGTAM_PHONGBAN	=>	'Phòng thuộc Trung tâm',
	...
	public	$pham_vi = array(
		...
		self::PHAMVI_VIENTHONG_PHONGBAN_TODOI=>	'Tổ đội thuộc phòng ban chức năng',		self::PHAMVI_VIENTHONG_PHONGBAN	=>	'Chỉ phòng ban đang công tác',
 ...
 */
	...
	public	function	cboNhanvien($permission)
	{
		...
		$this->loadModel('Nhanvien');		if(isset($quyen['HeThong.toanquyen']))
			return $this->Nhanvien->listNhanvien2Combobox(0);		if(!isset($quyen[$permission]))	return null;

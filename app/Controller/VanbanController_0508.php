		...
		if(!empty($this->request->data))
		{
			...
			if($chuyen_nguoiduyet == 0) //ko chuyển cho PGĐ duyệt
			{
				...
				$up_date = $this->Vanban->updateAll(
						array('tinhtrang_duyet' => 1, 'noidung_duyet' => "'" . $noidung_duyet . "'", 'phongphoihop_id' => "'" . $phongphoihop_id . "'", 'importance' => $importance,'vb_gap' => $vb_gap, 'vbgap_ngayhoanthanh' => "'".$vbgap_ngayhoanthanh."'", 'donviduyet_id' => $donviduyet_id, 'ngay_duyet' =>  "'".$ngay_duyet. "'"),
						array('Vanban.id' 	=> $id )
						);

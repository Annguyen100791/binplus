...
//pr($nv); die();
...

	{
...

		{
			...
			}/*elseif(!empty($this->request->data['Tinnhan']['nguoinhan_to'])){

				array_push($this->request->data['Chitiettinnhan'], array('nguoinhan_id' => $this->request->data['Tinnhan']['nguoinhan_to']));
...
/********************** Hà thêm **************************/
				...
				if(!empty($this->request->data['Tinnhan']['nguoinhan_to'])){					
						...
						$tam = array(
							...
							'nguoinhan_id'		=> $this->request->data['Tinnhan']['nguoinhan_to'],
							'loai_nguoinhan'		=> 1	
								);
...
/******************** End Hà thêm *************************************/
        ...
        }else	// show form compose
		{
			...
			//Lấy ds nhân viên trong combo list
			//$nv =$this->Nhanvien->listNhanvienAutocomplete();
			//$nvds = $this->cboNhanvien('TinNhan.soanthao');	

			//$this->set(compact('nvds'));

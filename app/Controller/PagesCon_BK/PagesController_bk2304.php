...
class PagesController extends AppController 
{
	...
	public	function	notice()
	{
		...
		*/
		...
		//pr($vb_traodoi);die();
		$this->Vanban->unbindModel(array('hasMany' => array('Traodoivanban')), false);
		...
		$this->set(compact('vanban', 'tinnhan', 'duocgiao_chuahoanthanh', 'duocgiao_dangthuchien', 'dagiao_chuahoanthanh', 'dagiao_dangthuchien','dagiao_khan','duocgiao_khan', 'lichcanhan', 'vanbanden_trinh', 'vanbanden_duyet','dagiao_baocao','duocgiao_baocao','vanban_thaydoi','vb_traodoi'));
		$this->render();

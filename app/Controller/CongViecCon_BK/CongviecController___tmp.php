...
class CongviecController extends AppController {
	...
	protected $paginate = array(
        'limit' => 	20,
		'findType' => 'threaded',
		'order'	=>	'Congviec.id, Congviec.vanban_id DESC'
...

		{
...

			{
				...
				case 'dagiao':
					...
					$conds = array('nguoi_giaoviec_id' => $this->Auth->user('nhanvien_id'), 'parent_id'=>'');
...
//pr($data);die();
...

	{
...

		{
			...
			//$this->redirect('/congviec/ds_nguoinhanviec');
